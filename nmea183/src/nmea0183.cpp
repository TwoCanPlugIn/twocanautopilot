...
*/
   ...
   response_table.Append( (RESPONSE *) &Dsc );
   response_table.Append( (RESPONSE *) &Dse );
   ...
   response_table.Append( (RESPONSE *) &Mob );
...
//   ASSERT_VALID( this );
   ...
   ** Edited to support IS VDM messages beginning with !
   */

 	if ((sentence.Sentence[0] != '$') && (sentence.Sentence[0] != '!'))
   {
      return( false );
   }
