...
///////////////////////////////////////////////////////////////////////////////
class AutopilotDialogBase : public wxDialog
{
	private:
	...
	public:
		...
		AutopilotDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Autopilot"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE );
		~AutopilotDialogBase();
